<div class="form-group {{ $errors->has('number') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="number" type="number" id="number" value="{{ isset($question->number) ? $question->number : ''}}" >
...
<div class="form-group {{ $errors->has('answer1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="answer1" type="text" id="answer1" value="{{ isset($question->answer1) ? $question->answer1 : ''}}" >
...
<div class="form-group {{ $errors->has('answer2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="answer2" type="text" id="answer2" value="{{ isset($question->answer2) ? $question->answer2 : ''}}" >
...
<div class="form-group {{ $errors->has('answer3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="answer3" type="text" id="answer3" value="{{ isset($question->answer3) ? $question->answer3 : ''}}" >
...
<div class="form-group {{ $errors->has('answer4') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="answer4" type="text" id="answer4" value="{{ isset($question->answer4) ? $question->answer4 : ''}}" >
